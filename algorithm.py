...
class App:
    ...
    def __init__(self, questions_deck):
        ...
        # Image for question - start with a blank image placeholder
        # Use an empty PhotoImage rather than a file (avoids trying to load "")
    ...
    def next_question(self):
        ...
        if self.data_list and self.wrong_questions_list:
            ...
            # Clear image when there are no more questions
            self._clear_image()
            return
        ...
        # Update image based on the newly set current_question
        self._update_image()
    ...
    def get_one_wrong_question(self):
        ...
        question: list[str] = self.wrong_questions_list.pop()
        question = [item.strip() for item in question]
        question[1] = question[1].split(" | ")
        question[1] = "\n".join(question[1])
        return question[0], question[1]
        ...
        with open(filename, "r", encoding="UTF-8") as csvfile:
            ...
            for row in csv_reader:
                if row:
                    ...
                    data_list.append([item.strip() for item in row])
        return data_list
...
if __name__ == "__main__":
    deck = "algorithm_30_card.csv" # Default deck
